...
const FearfulIcon = () => <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="M8 14s1.5 2 4 2 4-2 4-2" /><path d="M12 9v2 M12 13v2" /></svg>;
const DisgustIcon = () => <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="M8 16h8" /><path d="M9 9h.01 M15 9h.01" /><path d="M12 6v2" /></svg>;
...
const Welcome = () => {
  ...
  const moodsList = [
    ...
    { mood: "Fearful", icon: <FearfulIcon />, color: "#FFA726" },
    { mood: "Disgust", icon: <DisgustIcon />, color: "#8B5CF6" },
  ];
